...
#ifndef XSTREAMSDK_SWIFT_H
#define XSTREAMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XStreamSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, APICallCachePolicy, open) {
  ...
  APICallCachePolicyReturnOnlyCache = 3,
};
...
SWIFT_PROTOCOL("_TtP10XStreamSDK18XStreamSDKDelegate_")
@protocol XStreamSDKDelegate
...
SWIFT_PROTOCOL("_TtP10XStreamSDK28XtreamInputInterfaceProtocol_")
@protocol XtreamInputInterfaceProtocol
...
@property (nonatomic, readonly, copy) NSString * _Nonnull atvDID;
...
@property (nonatomic, readonly) BOOL toEnableRemote;
@property (nonatomic, readonly, copy) NSString * _Nonnull faqQuestionsURL;
@end
